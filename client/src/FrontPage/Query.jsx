...
const Query = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://aakashacademy.in/get-queries')
      .then(response => {
  ...
  const handlePostQuery = () => {
    ...
    axios.post('https://aakashacademy.in/post-query', { query: newQuery })
      .then(response => {
  ...
  const handlePostReply = (queryId) => {
    ...
    axios.post(`https://aakashacademy.in/post-reply/${queryId}`, { reply: replyText })
      .then(response => {
